...
// template <class VertexRange>
// auto marked_vertices(const VertexRange& vertices, const SM_marking_map&
// marking_map, 					 const Vertex_mark mark);

// template <class VertexRange>
// auto none_vertices(const VertexRange& vertices, const SM_marking_map&
// marking_map);
